...
__exports.__wbg_instanceof_Array_cf546715a95a6fde = function(idx) {
    return getObject(idx) instanceof Array ? 1 : 0;
};

__exports.__wbg_new_463e12e5f8d02226 = function() {
    return addHeapObject(new Array());
};

const __wbg_pop_1beed5456bdc66be_target = typeof Array === 'undefined' ? null : Array.prototype.pop || function() {
    throw new Error(`wasm-bindgen: Array.pop does not exist`);
};

__exports.__wbg_pop_1beed5456bdc66be = function(arg0) {
    return addHeapObject(__wbg_pop_1beed5456bdc66be_target.call(getObject(arg0)));
};

const __wbg_push_1d168d5a770e03cf_target = typeof Array === 'undefined' ? null : Array.prototype.push || function() {
    throw new Error(`wasm-bindgen: Array.push does not exist`);
};

__exports.__wbg_push_1d168d5a770e03cf = function(arg0, arg1) {
    return __wbg_push_1d168d5a770e03cf_target.call(getObject(arg0), getObject(arg1));
};

__exports.__wbg_new_f3d706eee21a282e = function(arg0, arg1) {
    let varg0 = getStringFromWasm(arg0, arg1);
...
__exports.__wbg_call_9a6451120c0e32db = function(arg0, arg1, arg2, exnptr) {
    try {
...
__exports.__wbg_new_151f9251aaf6372e = function(arg0) {
    return addHeapObject(new Uint8ClampedArray(getObject(arg0)));
};

const __wbg_slice_a19547f73a5901b4_target = typeof Uint8ClampedArray === 'undefined' ? null : Uint8ClampedArray.prototype.slice || function() {
    throw new Error(`wasm-bindgen: Uint8ClampedArray.slice does not exist`);
};

__exports.__wbg_slice_a19547f73a5901b4 = function(arg0, arg1, arg2) {
    return addHeapObject(__wbg_slice_a19547f73a5901b4_target.call(getObject(arg0), arg1, arg2));
};
...
__exports.__wbg_new_5ec8c05dbefa35f1 = function(arg0) {
...
__exports.__wbg_resolve_8d5554a087221239 = function(arg0) {
...
__exports.__wbg_then_1aeefc3ac0acfca9 = function(arg0, arg1) {
    return addHeapObject(__wbg_then_1aeefc3ac0acfca9_target.call(getObject(arg0), getObject(arg1)));
};

const __wbg_buffer_09945aee7080740e_target = GetOwnOrInheritedPropertyDescriptor(typeof WebAssembly.Memory === 'undefined' ? null : WebAssembly.Memory.prototype, 'buffer').get || function() {
    throw new Error(`wasm-bindgen: WebAssembly.Memory.buffer does not exist`);
};

__exports.__wbg_buffer_09945aee7080740e = function(arg0) {
    return addHeapObject(__wbg_buffer_09945aee7080740e_target.call(getObject(arg0)));
};
